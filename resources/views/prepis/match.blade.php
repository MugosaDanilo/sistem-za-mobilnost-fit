                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative searchable-container" data-type="student">
                            ...
                            <div class="search-results absolute z-50 w-full bg-white border border-gray-300 rounded-lg shadow-lg mt-1 max-h-60 overflow-y-auto hidden">
                            </div>
                            <select name="student_id" id="student_id" class="hidden">
                                <option value="">Odaberi studenta</option>
                                @foreach($students as $student)
                                <option value="{{ $student->id }}" data-text="{{ $student->ime }} {{ $student->prezime }} ({{ $student->br_indexa }})">
                                    {{ $student->ime }} {{ $student->prezime }} ({{ $student->br_indexa }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-6 select-none">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="flex flex-col bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                                ...
                                <input type="text" id="search-subject" placeholder="Pretraži predmete..." class="mb-2 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" disabled>
                                <div id="subject-list" class="h-[500px] overflow-y-auto space-y-2 p-1 border border-gray-100 rounded bg-gray-50">
                                    <p class="text-gray-500 text-sm text-center mt-4">Odaberite studenta/fakultet da prikažete predmete</p>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col space-y-4">
                                ...
                                <div id="drop-zone" class="bg-blue-50 border-2 border-dashed border-blue-300 rounded-lg p-6 flex flex-col items-center justify-center transition-colors min-h-[150px]">
                                    <p class="text-blue-500 font-medium text-center mb-2">Odaberite studenta/fakultet da prikažete predmete.</p>
    ...
    <div id="matchInfoModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 hidden items-center justify-center z-[60]">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden transform transition-all">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                <h3 class="text-lg font-semibold text-gray-800">Informacije o zahtjevu</h3>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function renderSubjectList() {
                ...
                if (!state.selectedStudentId) {
                    els.subjectList.innerHTML = '<p class="text-gray-500 text-sm text-center mt-4">Odaberite studenta za prikaz predmeta</p>';
