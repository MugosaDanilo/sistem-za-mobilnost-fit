        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <!-- Faculty Selection -->
                    <div class="mb-6">
                        <label for="fakultet_id" class="block text-sm font-medium text-gray-700">Fakultet (za
                            predmete)</label>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="flex flex-col bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                                ...
                                <div id="subject-list" class="h-[500px] overflow-y-auto space-y-2 p-1 border border-gray-100 rounded bg-gray-50">
                                    <p class="text-gray-500 text-sm text-center mt-4">Odaberite fakultet da prikažete predmete.
                                    </p>
                                </div>
                            </div>
                        </div>
