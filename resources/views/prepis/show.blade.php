    ...
    <div class="py-10 max-w-6xl mx-auto px-6">
        ...
        <div class="bg-white shadow rounded-lg p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="mt-2 text-gray-600"><span class="font-medium">Ime:</span> {{ $prepis->student->ime }} {{ $prepis->student->prezime }}</p>
                    <p class="text-gray-600"><span class="font-medium">Broj indeksa:</span> {{ $prepis->student->br_indexa }}</p>
                </div>
                <div>
                    ...
                    <p class="text-gray-600"><span class="font-medium">Datum:</span> {{ $prepis->datum->format('d.m.Y') }}</p>
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">Povezani predmeti (Ugovori)</h2>
            </div>
