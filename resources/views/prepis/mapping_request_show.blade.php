    ...
    <div class="py-10 max-w-7xl mx-auto px-6">
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <h1 class="text-3xl font-bold text-gray-900">Pregledaj zahtjev za povezivanje</h1>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-lg font-medium text-gray-900">{{ $mappingRequest->student->ime }}
                                    {{ $mappingRequest->student->prezime }}</div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-sm text-gray-500">Profesor koji pregleda</div>
                            </div>
                        </div>
            ...
            <div class="bg-white shadow-sm rounded-xl overflow-hidden border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    <h2 class="text-lg font-semibold text-gray-800">Povezivanja predmeta</h2>
                    <span class="bg-indigo-100 text-indigo-800 text-xs font-medium px-2.5 py-0.5 rounded-full">{{ $mappingRequest->subjects->count() }}
                        Predmeti</span>
                </div>
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Strani predmet</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Dodijeljeni profesor</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Povezani FIT predmet</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Akcije</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    @else
                                    <span class="text-gray-400 text-xs">Akcije zaključane</span>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
            ...
            <div class="bg-white shadow-sm rounded-xl overflow-hidden border border-gray-200 mt-6 select-none">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    <h2 class="text-lg font-semibold text-gray-800">Dodaj predmete za povezivanje</h2>
                    <span class="text-xs text-gray-500">Prevuci za povezivanje</span>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <!-- Student Subjects Column (Source) -->
                        <div class="flex flex-col bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                            <h4 class="font-semibold text-gray-700 mb-2">Nepovezani predmeti studenta</h4>
                        ...
                        <div class="flex flex-col space-y-4">
                            ...
                            <div id="drop-zone" class="bg-blue-50 border-2 border-dashed border-blue-300 rounded-lg p-4 flex flex-col items-center justify-center transition-colors min-h-[120px]">
                                ...
                                <div class="flex items-center space-x-2 w-full justify-center">
                                    <div id="drop-slot-subject" class="w-1/2 h-10 bg-white border border-gray-200 rounded flex items-center justify-center text-xs text-gray-400 text-center px-1 truncate">
                                        Predmet</div>
                                    <span class="text-gray-400 text-xs">+</span>
                                    <div id="drop-slot-prof" class="w-1/2 h-10 bg-white border border-gray-200 rounded flex items-center justify-center text-xs text-gray-400 text-center px-1 truncate">
                                        Profesor</div>
                                </div>
                            </div>
                            ...
                            <div class="flex-1 bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col h-[260px]">
                                <div class="p-2 border-b border-gray-200 bg-gray-50 rounded-t-lg flex justify-between items-center">
                                    <h4 class="font-semibold text-gray-700 text-sm">Nova podudaranja</h4>
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    function updateSlot(el, item, type, placeholder) {
                        if (item) {
                            ...
                            el.onclick = () => {
                                state[type === 'professor' ? 'pendingProf' : 'pendingSubject'] = null;
                                render();
                            };
                        } else {
