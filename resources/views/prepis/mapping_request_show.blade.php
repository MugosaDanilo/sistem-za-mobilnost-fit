<x-app-layout>
    ...
    <div class="py-10 max-w-7xl mx-auto px-6">
        <div class="space-y-6">
            ...
            <div class="bg-white shadow-sm rounded-xl overflow-hidden border border-gray-200">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @else
                        <span class="text-gray-500 italic">Nema profesora</span>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-xl overflow-hidden border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    <h2 class="text-lg font-semibold text-gray-800">Povezivanje predmeta</h2>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ...
                                    <div class="p-2 rounded-md {{ $subjectStatusBg }} {{ $subjectStatusColor }}">
                                        ...
                                        @else
                                        <span>Nema podudaranja / Na čekanju</span>
                                        @endif
                                    </div>
                                </td>
