                        ...
                        <tr class="bg-white subject-row" data-search="{{ strtolower($p->naziv) }}">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex justify-center space-x-2">
                                    <form
                                        action="{{ route('users.subjects.destroy', ['id' => $user->id, 'predmet_id' => $p->id]) }}"
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
            ...
            <form action="{{ route('users.subjects.store', $user->id) }}" method="POST">
                ...
                <div class="mb-4 relative">
                    <label for="subjectSearchInput" class="block text-gray-700 font-medium mb-1">Pretraži
                        Predmet</label>
                    <input type="text" id="subjectSearchInput" placeholder="Unesite naziv predmeta..."
                        ...
                        autocomplete="off">
                    <div id="subjectSearchResults"
                        class="absolute z-10 w-full bg-white border border-gray-300 rounded-lg shadow-lg mt-1 max-h-40 overflow-y-auto hidden">
                    </div>
