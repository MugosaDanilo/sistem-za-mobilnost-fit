        ...
        <div class="bg-white shadow-sm rounded-xl overflow-hidden border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('students.index') }}" class="text-blue-600 hover:text-blue-800 font-semibold">
                    &larr; Nazad na upravljanje studentima
                </a>
            </div>
            ...
            <form x-data action="{{ route('students.update', $student->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" id="ime" name="ime" value="{{ old('ime', $student->ime) }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="prezime" name="prezime" value="{{ old('prezime', $student->prezime) }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="br_indexa" name="br_indexa" value="{{ old('br_indexa', $student->br_indexa) }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                        @error('br_indexa') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="datum_rodjenja" class="block text-gray-700 font-medium mb-1">Datum rođenja</label>
                        <input type="date" id="datum_rodjenja" name="datum_rodjenja" value="{{ old('datum_rodjenja', $student->datum_rodjenja) }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="telefon" name="telefon" value="{{ old('telefon', $student->telefon) }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                        @error('telefon') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="email" class="block text-gray-700 font-medium mb-1">Email</label>
                        <input type="email" id="email" name="email" value="{{ old('email', $student->email) }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                        @error('email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="godina_studija" class="block text-gray-700 font-medium mb-1">Godina Studija</label>
                        <input type="number" id="godina_studija" name="godina_studija" value="{{ old('godina_studija', $student->godina_studija) }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="jmbg" name="jmbg" value="{{ old('jmbg', $student->jmbg) }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center space-x-6">
                            <label class="inline-flex items-center">
                                <input type="radio" name="pol" id="pol_muski" value="musko" {{ old('pol', $student->pol) == 'musko' ? 'checked' : '' }} class="form-radio text-blue-600" />
                                <span class="ml-2 text-gray-700">Muški</span>
                            </label>

                            <label class="inline-flex items-center">
                                <input type="radio" name="pol" id="pol_zenski" value="zensko" {{ old('pol', $student->pol) == 'zensko' ? 'checked' : '' }} class="form-radio text-blue-600" />
                ...
                try {
                    ...
                    alert('Failed to load subjects for the selected faculty.');
                        ...
                        <div class="mb-4">
                            ...
                            <select name="fakultet_id" x-model="selectedFaculty" @change="window.dispatchEvent(new CustomEvent('clear-selection')); fetchSubjects()" x-init="if(selectedFaculty) fetchSubjects()" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4 md:col-span-2">
                        <div class="mb-4">
                            ...
                            <select name="nivo_studija_id" required class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" onchange="window.dispatchEvent(new CustomEvent('study-level-changed', { detail: this.value }))" x-init="$nextTick(() => window.dispatchEvent(new CustomEvent('study-level-changed', { detail: $el.value })))">
                                <option value="">Odaberi nivo studija</option>
