...
=======
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" id="ime" name="ime" value="{{ old('ime') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                        @error('ime') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
>>>>>>> 35a45f9 (prevod sajta)

                    <div class="mb-4">
                        <label for="prezime" class="block text-gray-700 font-medium mb-1">Prezime</label>
                        <input type="text" id="prezime" name="prezime" value="{{ old('prezime') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="br_indexa" name="br_indexa" value="{{ old('br_indexa') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" id="datum_rodjenja" name="datum_rodjenja" value="{{ old('datum_rodjenja') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="telefon" name="telefon" value="{{ old('telefon') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                        @error('telefon') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="email" class="block text-gray-700 font-medium mb-1">Email</label>
                        <input type="email" id="email" name="email" value="{{ old('email') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                        @error('email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="godina_studija" class="block text-gray-700 font-medium mb-1">Godina studija</label>
                        <input type="number" id="godina_studija" name="godina_studija" value="{{ old('godina_studija') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="jmbg" name="jmbg" value="{{ old('jmbg') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <label class="inline-flex items-center">
                            <input type="radio" name="pol" id="pol_muski" value="musko" checked class="form-radio text-blue-600" />
                            <span class="ml-2 text-gray-700">Muški</span>
                        </label>

                        <label class="inline-flex items-center">
                            <input type="radio" name="pol" id="pol_zenski" value="zensko" class="form-radio text-blue-600" />
