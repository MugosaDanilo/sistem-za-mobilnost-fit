                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <h2 class="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">Informacije o studentima i fakultetima</h2>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <!-- Student Selection -->
                                <div class="relative">
                                    <label for="student_search" class="block text-sm font-medium text-gray-700 mb-1">Odaberite studenta</label>
                                    <div class="relative">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex flex-col h-full">
                                    <h3 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Nepoloženi predmeti
                                        (Prethodne godine)</h3>
                                ...
                                <!-- Next Year Subjects -->
                                <div class="flex flex-col h-full">
                                    <h3 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Predmeti naredne godine</h3>
